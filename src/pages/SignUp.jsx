...
function SignUp() {
    ...
    function submitSign() {
        ...
        checkUser(obj).then(data =>
            data.length == 0 ?
                addUser(obj).then(() => toast.success('Registration was successful') , navigate('/signIn') ) :
