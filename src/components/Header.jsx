    ...
    return (
        <>
            ...
            <div className='header-bg' >
                <header className={`${location.pathname == '/flights/transport/tickets/' ? 'container2 header2' : location.pathname == '/profile/saved' ? 'container3 header2' : 'container header' }`}>
                    <div>
                        <Link to={'/'} >
